...
class _SetPoints(object):
    ...
    def __init__(self, _winter, _summer, _mechanical_cooling):
        ...
        self.winter = None if isinstance(_winter, list) and not _winter else _winter
        self.summer = None if isinstance(_summer, list) and not _summer else _summer
...
class GHCompo_BuildingSegment(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.mech_room_temp = None if isinstance(_mech_room_temp, list) and not _mech_room_temp else _mech_room_temp
